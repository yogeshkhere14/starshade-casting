...
export function ImdbIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
...
export function PhoneIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    ...
    >
      <path d="M6.62 10.79a15.91 15.91 0 0 0 6.59 6.59l2.2-2.2a1 1 0 0 1 1.01-.24c1.12.37 2.33.57 3.58.57a1 1 0 0 1 1 1v3.5a1 1 0 0 1-1 1C10.29 21 3 13.71 3 4.5a1 1 0 0 1 1-1H7.5a1 1 0 0 1 1 1c0 1.25.2 2.46.57 3.58a1 1 0 0 1-.24 1.01l-2.2 2.2Z" />
    </svg>
  )
}

export function AlertIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      <path
        d="M12 3a6 6 0 0 0-6 6v3c0 .4-.2.8-.5 1.1l-1.3 1.3a1 1 0 0 0 .7 1.7h15.2a1 1 0 0 0 .7-1.7l-1.3-1.3a1.5 1.5 0 0 1-.5-1.1V9a6 6 0 0 0-6-6Z"
        className="fill-zinc-100 stroke-zinc-400 dark:fill-zinc-100/10 dark:stroke-zinc-500"
      />
      <path
